...
![随机插入与有序插入导致的两种 BST 形状](./AVL树_课程讲义.assets/fig_01_bst_degeneracy_0020.jpg)
...
![AVL 定义、平衡因子及示例树](./AVL树_课程讲义.assets/fig_02_avl_definition_balance_factor_0100.jpg)
...
![旋转的动机：降低高度并保持 BST 中序遍历不变](./AVL树_课程讲义.assets/fig_03_rotation_principle_0160.jpg)
...
![LL 型右旋与 RR 型左旋的并列示意](./AVL树_课程讲义.assets/fig_04_ll_rr_single_rotations_0250.jpg)
...
![LR 与 RL 折线型失衡的初始结构和两步操作](./AVL树_课程讲义.assets/fig_05_lr_rl_double_rotation_0520.jpg)
...
![双旋后以中间节点为局部根，恢复平衡](./AVL树_课程讲义.assets/fig_06_lr_rl_balanced_result_0610.jpg)
...
![AVL 插入的递归回溯、更新高度与失衡判断](./AVL树_课程讲义.assets/fig_07_insertion_backtracking_0790.jpg)
...
![视频总结：AVL 的优点、缺点与红黑树的工程动机](./AVL树_课程讲义.assets/fig_08_avl_summary_redblack_0880.jpg)
